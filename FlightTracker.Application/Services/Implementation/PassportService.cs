...
public class PassportService : IPassportService
{
    ...
    public async Task<Result<PassportDataDto>> GetPassportDataAsync(int userId, CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            return Result<PassportDataDto>.Success(dto);
        }
        ...
        catch (Exception ex)
        {
            return Result<PassportDataDto>.Failure(
                ex.Message,
                "passport.data.load_failed");
        }
    }

    public async Task<Result<PassportDetailsDto>> GetPassportDetailsAsync(int userId, CancellationToken cancellationToken = default)
    {
        try
        {
